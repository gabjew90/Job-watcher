...
<!-- Owner-curated. This whole file is shown to the drafter and to the
revision pass. Edit it to tune the voice; the rules with a checkmark are
also enforced in code (src/resume.py style_lint) and reported in the issue
comment when a draft breaks them. -->

Write like a person who has done the work and is in a hurry. Plain words,
short sentences, one idea per bullet. The reader is a hiring manager
skimming for thirty seconds and an ATS parser that wants exact terms.
...
spearheaded, leveraged, leveraging, drive, driving, driven, cross-functional,
passionate, proven track record, robust, seamless, holistic, dynamic,
cutting-edge, synergy, synergies, utilize, utilizing, impactful, innovative,
world-class, best-in-class, stakeholders (say who: utilities, regulators,
customers), ecosystem, transformative, empower.

For "cross-functional teams", name the teams: battery, enclosure, PCS,
controls, HVAC and fire systems.

## Summary

- Two or three sentences, 60 words max. ✔ No sentence over 30 words. ✔
- Sentence one: what he does now, in plain terms. Sentence two: what he has
  done that matters for this role. Sentence three: credentials (PE, MBA) if
  the role cares.
- No "at the intersection of", no "leader", no "seasoned", no "results".
...
datacenter power customers.
After: Senior product manager for grid-scale battery storage sold to AI
